    ...
    public Command getCommand(char currentOperator) {
        ...
        switch (currentOperator) {
            ...
            case BrainFuckConstants.SHIFT_LEFT:
                ...
                break;
            case BrainFuckConstants.INCREMENT_VALUE:
                command = new IncrementValue();
                break;
            case BrainFuckConstants.DECREMENT_VALUE:
                command = new DecrementValue();
                break;
            case BrainFuckConstants.PRINT_TO_CONSOLE:
                command = new PrintToConsole();
                break;
